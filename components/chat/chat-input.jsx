  ...
  return (
    <form className="w-5/6 fixed bottom-0 p-3 ">
      <div className="rounded-lg border border-gray-400">
        ...
        <div className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-[#022639]">
          <textarea
            id="chat"
            rows="1"
            className="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-[#011d2b] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
